...
export class Signup extends Component {
  ...
  createAccount=()=>
  {
    ...
    History.push('/Login')
    axios.post("http://localhost:8002/users/signup",{
        ...
        <div id="signupback">
            <div id="signupwindow">
                ...
                <div id="tc">
                  ...
                  I agree to E-cart <a href='https://policies.google.com/privacy?hl=en-US' target='blank' className='agred'><span>Terms of Service, Privacy Policy</span></a> and<br></br>
                  <a href='' className='agred' target='blank'><span>Content Policies</span></a>
                  </label>
                </div>
