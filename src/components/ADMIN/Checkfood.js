...
export default class AdminCheckFood extends Component {
    ...
    componentDidMount(){
        axios.post("http://localhost:8003/ecart/get-fooditems", this.obj)
        .then((resp)=>{
    ...
    deleteFood = (e) =>{
        axios.post("http://localhost:8001/ecart/admin/delete-fooditem",
        {
            restaurantid:this.obj.restaurantid,
            food_item_id:parseInt(e.target.parentNode.parentNode.id)
        })
        .then((resp)=>
        {
