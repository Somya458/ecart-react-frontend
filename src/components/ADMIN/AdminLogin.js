...
export default class AdminLogin extends Component {
    ...
    componentDidMount(){
        ...
        axios.get("http://localhost:8003/ecart/get-restaurants")
        .then((resp)=>{
    ...
    deleteRestaurant = (e) =>{
        e.preventDefault();
        console.log(e.target.parentNode.parentNode.id)
        const restaurantId = parseInt(e.target.parentNode.parentNode.id, 10);

        axios.delete("http://localhost:8001/ecart/admin/delete-restaurant", {
    ...
    logout=()=>
    {
        axios.post("http://localhost:8002/users/logout",{phonenumber:this.phone})
        .then((resp)=>
        {
            console.log(resp.data)
        })
