...
export default class Addrestaurant extends Component {
    ...
    submit = (e) => {
        ...
        this.restaurant.restaurant_rating = 1.1;  // Direct assignment
    
        console.log("Submitting:", this.restaurant);
    
        axios.post("http://localhost:8001/ecart/admin/add-restaurant", this.restaurant)
            .then((resp) => {
