...
export default class AdminEditRest extends Component {
    ...
    submit = (e) => {
        ...
        this.restaurant.restaurantname = restaurantNameInput.value.trim() || restaurantNameInput.placeholder;
        this.restaurant.address = restaurantAddressInput.value.trim() || restaurantAddressInput.placeholder;
    
        console.log("Submitting data:", this.restaurant);
    
        axios.put("http://localhost:8001/ecart/admin/edit-restaurant", this.restaurant)
            .then((resp) => {
